    ...
    <section className="highlights">
      ...
      <div className="highlights--container">
        <div className="highlights--box highlights--box__big">
          <h5>Wind status</h5>
          <h3>
            {getWindSpeed(consolidated_weather)}
            <span>mph</span>
          </h3>
          <div className="wind--direction">
            {getWindDirection(consolidated_weather)}
            <h5>{getWindDirectionCompas(consolidated_weather)}</h5>
          </div>
        </div>
        <div className=" highlights--box highlights--box__big">
          <h5>Humidity</h5>
          <h3>
            {getHumidity(consolidated_weather, 0)}
            <span>%</span>
          </h3>
          <h5>Bar</h5>
        </div>
        <div className="highlights--box highlights--box__small">
          <h5>Visibility</h5>
          <h3>
            {getVisibility(consolidated_weather, 0)} <span>miles</span>{" "}
          </h3>
        </div>
        <div className="highlights--box highlights--box__small">
          <h5>Air Pressure</h5>
