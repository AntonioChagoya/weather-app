...
function SidebarSearch(sidebarState) {
  ...
  async function searchWoeid(e) {
    ...
    try {
      ...
      alert(
        `Your search can't be completed, please consult available woeid list at: https://www.findmecity.com/`
      );
    }
  }
  ...
  return (
    <div className="sidebar--search">
      <div className="search--close">
        <button onClick={handleInputChange} className="search-button__close">
          <CloseIcon />
        </button>
      </div>
        ...
        <form className="knowncities" onSubmit={cityItem}>
          <div className="search--states-list">
            <ul>
              <li>
                <button
                  onClick={(e) => setSearchState(e.target.value)}
                  type="submit"
                  value="London"
                >
                  London
